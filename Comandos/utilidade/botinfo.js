...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        let dono = "217754567280951298"; // Coloque seu ID
        ...
        let embed = new Discord.EmbedBuilder()
            ...
            .setDescription(`Olá ${interaction.user}, veja minhas informações abaixo:\n\n> 🤖 Nome: \`${bot}\`.\n> 🤖 Devs: [Desenvolvedores](https://docs.google.com/spreadsheets/d/1TBwCTjUNKEDaerDoC3wbkOdb1sFua7wJe9P7UBq2Giw/edit#gid=0)
